...
BEGIN
    ...
    IF v_server = 'chihuahua' THEN
        INSERT INTO sales_chihuahua (orchard_name, sale_date, price, quantity_sold)
        VALUES (p_orchard_name, p_sale_date, p_price, p_quantity_sold);

    ELSIF v_server = 'cuauhtemoc' THEN
        INSERT INTO sales_cuauhtemoc (orchard_name, sale_date, price, quantity_sold)
        VALUES (p_orchard_name, p_sale_date, p_price, p_quantity_sold);

    ELSIF v_server = 'juarez' THEN
        INSERT INTO sales_juarez (orchard_name, sale_date, price, quantity_sold)
        VALUES (p_orchard_name, p_sale_date, p_price, p_quantity_sold);
