...
BEGIN
    ...
    ELSIF v_server = 'juarez' THEN
        INSERT INTO apple_orchard_sales@chihuahua_juarez (orchard_id, sale_date, price, quantity_sold)
        VALUES (p_orchard_id, p_sale_date, p_price, p_quantity_sold);

    ELSIF v_server = 'cuauhtemoc' THEN
        INSERT INTO apple_orchard_sales@chihuahua_cuauhtemoc (orchard_id, sale_date, price, quantity_sold)
        VALUES (p_orchard_id, p_sale_date, p_price, p_quantity_sold);
...
BEGIN
    ...
    ELSIF v_server = 'juarez' THEN
        UPDATE apple_orchards@chihuahua_juarez
        SET orchard_name = p_new_name, location = p_new_location
        WHERE orchard_id = p_orchard_id;

    ELSIF v_server = 'cuauhtemoc' THEN
        UPDATE apple_orchards@chihuahua_cuauhtemoc
        SET orchard_name = p_new_name, location = p_new_location
        WHERE orchard_id = p_orchard_id;
...
BEGIN
    ...
    ELSIF v_server = 'juarez' THEN
        UPDATE apple_orchard_sales@chihuahua_juarez
        SET sale_date = p_new_sale_date,
            price = p_new_price,
            quantity_sold = p_new_quantity_sold
        WHERE sale_id = p_sale_id;
    ...
    ELSIF v_server = 'cuauhtemoc' THEN
        UPDATE apple_orchard_sales@chihuahua_cuauhtemoc
        SET sale_date = p_new_sale_date,
            price = p_new_price,
            quantity_sold = p_new_quantity_sold
        WHERE sale_id = p_sale_id;
...
BEGIN
    ...
    ELSIF v_server = 'juarez' THEN
        DELETE FROM apple_orchard_sales@chihuahua_juarez
        WHERE orchard_id = p_orchard_id;

        DELETE FROM apple_orchards@chihuahua_juarez
        WHERE orchard_id = p_orchard_id;

    ELSIF v_server = 'cuauhtemoc' THEN
        DELETE FROM apple_orchard_sales@chihuahua_cuauhtemoc
        WHERE orchard_id = p_orchard_id;

        DELETE FROM apple_orchards@chihuahua_cuauhtemoc
        WHERE orchard_id = p_orchard_id;
