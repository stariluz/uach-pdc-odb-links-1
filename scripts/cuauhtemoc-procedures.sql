...
BEGIN
    ...
    IF LOWER(p_server) = 'chihuahua' THEN
        INSERT INTO apple_orchards@cuauhtemoc_chihuahua (orchard_name, location, server)
        VALUES (p_orchard_name, p_location, LOWER(p_server));

    ELSIF LOWER(p_server) = 'juarez' THEN
        INSERT INTO apple_orchards@cuauhtemoc_juarez (orchard_name, location, server)
        VALUES (p_orchard_name, p_location, LOWER(p_server));
...
BEGIN
    ...
    IF v_server = 'chihuahua' THEN
        INSERT INTO apple_orchard_sales@cuauhtemoc_chihuahua (orchard_id, sale_date, price, quantity_sold)
        VALUES (p_orchard_id, p_sale_date, p_price, p_quantity_sold);

    ELSIF v_server = 'juarez' THEN
        INSERT INTO apple_orchard_sales@cuauhtemoc_juarez (orchard_id, sale_date, price, quantity_sold)
        VALUES (p_orchard_id, p_sale_date, p_price, p_quantity_sold);
