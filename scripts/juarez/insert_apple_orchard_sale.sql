...
BEGIN
    ...
    ELSIF v_server = 'cuauhtemoc' THEN
        INSERT INTO apple_orchard_sales@juarez_cuauhtemoc (orchard_name, sale_date, price, quantity_sold)
        VALUES (p_orchard_name, p_sale_date, p_price, p_quantity_sold);

    ELSIF v_server = 'chihuahua' THEN
        INSERT INTO apple_orchard_sales@juarez_chihuahua (orchard_name, sale_date, price, quantity_sold)
        VALUES (p_orchard_name, p_sale_date, p_price, p_quantity_sold);
